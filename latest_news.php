...
<body>
    ...
    <div class="restrictNav_latest_news"></div>

    <section class="trending-to-container ruler-meter">

        <div class="ncontainer">

            <div class="search-container" style="padding-block-start: 20px;padding-block-end: 20px;margin-block-end: 20px;background: #fff;">
                <div class="search-title">
                    <p>Latest News</p><span class="text-muted">What are the trending articles and stories. Get in deep!</span>
                </div>
            ...
            <div class="div-container">
                ...
                <div class="left-div-container">
                            ...
                            ?>
                                    <a href="article/<?= $row_category_article1['ArticleID']; ?>/<?= urlencode($row_category_article1['Article_link']); ?>" class="list-div-left">
                                        <div class="div-img-left">
                                            <img
                                                src="gp-admin/admin/images/uploaded/<?= $row_category_article1['Image']; ?>"
                                                srcset="gp-admin/admin/images/uploaded/<?= $row_category_article1['Image']; ?> 1200w, 
                    gp-admin/admin/images/uploaded/<?= $row_category_article1['Image']; ?> 800w, 
                    gp-admin/admin/images/uploaded/<?= $row_category_article1['Image']; ?> 400w"
                                                sizes="(max-width: 600px) 400px, 
                   (max-width: 1000px) 800px, 
                   1200px"
                                                alt="<?= $row_category_article1['Title'] ?>"
                                                class="img-wrapper"
                                                loading="lazy">
                                        </div>
                    ...
                    <div class="first-list-cont">
                        ...
                        <div class="list-articles-content">
                            ...
                            $query_category_article2 = mysqli_query($con, "SELECT * FROM `article`
                                    ...
                                    ORDER BY article.Trending_score DESC LIMIT 7");
                   ...
                   1200px"
                    ...
                    <div class="second-ad tACenter">
                        <img src="assets/images/peiryshop_s.webp" alt="peiryshop_etsy_shop" class="img-wrapper" loading="lazy">
                        <span class="ad-text right-align">Peiry shop, get more products.</span>
                    </div>
                </div>
                    ...
                    ?>
                            ...
                            <div class="list-div-right">
                                <div class="div-img-right">
                                    <img
                                        src="gp-admin/admin/images/uploaded/<?= $row['Image']; ?>"
                                        srcset="gp-admin/admin/images/uploaded/<?= $row['Image']; ?> 1200w, 
                    gp-admin/admin/images/uploaded/<?= $row['Image']; ?> 800w, 
                    gp-admin/admin/images/uploaded/<?= $row['Image']; ?> 400w"
                                        sizes="(max-width: 600px) 400px, 
                   (max-width: 1000px) 800px, 
                   1200px"
                                        alt="<?= $row['Title'] ?>"
                                ...
                                <div class="div-content-left">
                                    ...
                                    <div class="author text-muted">
                                        <p class="article-date"><i class="authoricon fa-solid fa-clock"></i> <?= date('d M Y H:m:i', strtotime($row['Last_updated'])); ?></p>
            ...
            <div class="pagination-container">
                <ul class="pagination">
                    <?php if ($page > 1): ?>
                        <li><a href="latest-news?page=1" class="rounded">«</a></li>
                        <li><a href="latest-news?page=<?php echo $page - 1; ?>">‹</a></li>
                    <?php else: ?>
                    ...
                    <?php
                    if ($page > $range + 1) {
                        echo '<li><a href="latest-news?page=1">1</a></li>';
                        echo '<li><a class="dots disabled">...</a></li>';
                    }

                    for ($i = max(1, $page - $range); $i <= min($total_pages, $page + $range); $i++) {
                        echo '<li><a href="latest-news?page=' . $i . '" class="' . ($i == $page ? 'active' : '') . '">' . $i . '</a></li>';
                    }

                    if ($page < $total_pages - $range) {
                        echo '<li><a class="dots disabled">...</a></li>';
                        echo '<li><a href="latest-news?page=' . $total_pages . '">' . $total_pages . '</a></li>';
                    }
                    ?>

                    <?php if ($page < $total_pages): ?>
                        <li><a href="latest-news?page=<?php echo $page + 1; ?>">›</a></li>
                        <li><a href="latest-news?page=<?php echo $total_pages; ?>" class="rounded">»</a></li>
                    <?php else: ?>
                        <li><a class="disabled">›</a></li>
                        <li><a class="disabled rounded">»</a></li>
                    <?php endif; ?>
