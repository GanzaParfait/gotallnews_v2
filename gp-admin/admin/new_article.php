    ...
    if (in_array($img_extension, $extensions) === true) {
        ...
        try {
            ...
            if ($processedImages && count($processedImages) > 0) {
                ...
                // Insert article with all image sizes
                $new_article = mysqli_query($con, "INSERT INTO `article`(
                    `CategoryID`, `Title`, `Article_link`, `Image`, 
                    `image_large`, `image_medium`, `image_small`, `image_thumbnail`,
                    `Content`, `Published`, `AdminId`, `Date`
                ) VALUES (
                    '$category_id', '$title', '$seo_url', '$main_image',
                    '" . ($processedImages['large'] ?? '') . "',
                    '" . ($processedImages['medium'] ?? '') . "',
                    '" . ($processedImages['small'] ?? '') . "',
                    '" . ($processedImages['thumbnail'] ?? '') . "',
                    '$content', 'published', '$user_uniqueid', '$date'
                )");

                if ($new_article) {
                    echo "<script>alert('New article saved successfully with optimized WebP images!')</script>";
                } else {
                    // Clean up processed images if database insert fails
    ...
    <div class="main-container">
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="pd-20 card-box mb-30" style="border-radius: 2px;">
                    ...
                    <div class="page-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 text-right">
                                <a href="view_article.php" class="btn btn-light">
                                    <i class="icon-copy fa fa-table" aria-hidden="true"></i> Manage Articles
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div id="msg"></div>
                <form action="new_article.php" method="post" enctype="multipart/form-data" id="newformdata">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="custom-select2 form-control" required name="category_id"
                                    ...
                                    <optgroup label="Categories">
                                        <option value="nocategory" hidden selected>Select category...</option>
                                        <?php
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Image (<span class="text-dark">PNG, JPG, JPEG, GIF, WebP - Auto-converted to WebP</span>):</label>
                                <input class="form-control" type="file" name="image" required>
                                <small class="text-muted">
                                    <i class="icon-copy fa fa-info-circle"></i> 
                                    Images will be automatically converted to WebP format and optimized in multiple sizes for better performance.
                                </small>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="html-editor pd-20 card-box mb-30">
                        <textarea
                            ...
                            placeholder="New article, what's on your mind today..."></textarea>
                    </div>

                    <div class="row">
                        <div class="col-md-10 mb-2">
                            <button type="submit" class="btn btn-outline-primary"
                                style="width: 100%;" id="formdatabtn" name="newarticle">Save</button>
                        </div>
                        <div class="col-md-2">
