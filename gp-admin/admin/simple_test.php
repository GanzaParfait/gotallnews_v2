<?php
// Simple test without header includes
$host = 'localhost';
$username = 'root';
$password = '';
...
try {
    ...
    echo "<h2>Simple Statistics Test</h2>";
    ...
    if ($stmt) {
        ...
        // Count the parameters we're binding
        $params = [$profileId, $date, $articlesPublished, $totalViews, $totalLikes, $totalComments, $totalShares, $newFollowers, $engagementRate];
        echo "<p><strong>Parameters to bind:</strong> " . count($params) . "</p>";
